...
node_groups = {
  general = {
    instance_types = ["t3.medium"] # Worker node EC2 instance type. Change based on workload CPU/memory.
    ...
    min_size       = 1             # Minimum nodes Cluster Autoscaler can scale down to.
    desired_size   = 2             # Initial node count. Terraform ignores later autoscaler drift.
    max_size       = 4             # Maximum nodes Cluster Autoscaler can scale up to.
