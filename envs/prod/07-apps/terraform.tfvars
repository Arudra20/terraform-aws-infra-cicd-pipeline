...
apps = {
  user-service = {
    ...
    image_repository         = "432049653779.dkr.ecr.ap-south-1.amazonaws.com/eks-platform/dev/user-service" # Replace with ECR URL output.
    ...
    service_account_role_arn = "432049653779:role/eks-platform-dev-user-service"                                                                 # Replace with 05-irsa app_service_role_arn output or wire via remote state in main.tf.
  }
}
